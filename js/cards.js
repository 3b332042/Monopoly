export const CHANCE_CARDS = [
    ...
    { id: 'ch_11', text: "劫富濟貧！<br>從最富有的對手那裡獲得 $2000", type: 'steal', value: 2000 },
    ...
    { id: 'ch_13', text: "拆除大隊！<br>隨機拆除一名對手的一級建築", type: 'demolish' }
];
...
export const CHEST_CARDS = [
    ...
    { id: 'cc_12', text: "強力通緝！<br>最富有的一名對手被送進監獄", type: 'jail_victim' }
];
